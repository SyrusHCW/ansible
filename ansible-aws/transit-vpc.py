...
aws_pan = panorama.Panorama('1.1.1.1', 'admin', 'admin')

transit_asn = 65000
vpc_asn = 65001

tunnel_int1 = "tunnel.105"
tunnel_int2 = "tunnel.106"
...
xpath2 = '{0}{1}{2}'.format("/config/devices/entry[@name='localhost.localdomain']/template/entry[@name='T-DEVICE-AWS-TRANSIT']/config/devices/entry[@name='localhost.localdomain']/network/virtual-router/entry[@name='vr_master']/protocol/bgp/peer-group/entry[@name='BGP-Neghbor']/peer/entry[@name='", peer_address2, "']")
