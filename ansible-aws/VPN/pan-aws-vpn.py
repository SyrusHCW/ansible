...
#Global Variables
pan_username = sys.argv[1]
pan_password = sys.argv[2]

panorama_dns = '18.214.36.168'

az1_tunnelinsidecidr1 = '169.254.101.12/30'
az1_psk1 = '1234567890'

az1_tunnelinsidecidr2 = '169.254.101.16/30'
az1_psk2 = '1234567890'

az2_tunnelinsidecidr1 = '169.254.102.12/30'
az2_psk1 = '1234567890'

az2_tunnelinsidecidr2 = '169.254.102.16/30'
az2_psk2 = '1234567890'

interface1 = "tunnel.107"
interface2 = "tunnel.108"

print(pan_username)
# Build AZ 1
#Tunnel 1 Variables
tunnelinsidecidr1 = az1_tunnelinsidecidr1
psk1 = az1_psk1

#Tunnel 2 Variables
tunnelinsidecidr2 = az1_tunnelinsidecidr2
psk2 = az1_psk2

device_group = "DG-TECHNOLOGY-MFD612"

template = 'T-DEVICE-AWS-TRANSIT-AZ1'

aws_pan = panorama.Panorama(panorama_dns, pan_username, pan_password)

transit_asn = 65472
vpc_asn = 64512


tunnel_int1 = interface1
tunnel_int2 = interface2


ec2 = boto3.resource(
    'ec2',
    aws_access_key_id = 'AKIAJOXO5USHF4IXRRLA' ,
    aws_secret_access_key = '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' ,
)
...
for tags in range(0,count):
        ...
        if palo_transit == "transit:palo" and palo_true == "true":
                ...
                vpn_name = '{0}{1}'.format(env[0] , "-LE-TRANSIT-AZ1-VPN")
                ...
                cgw_name = "US1-DEV-TRANSIT-AZ1-CGW"
...
zone = security_zone[0]

peer1_bgp_xml = '{0}{1}{2}{3}{4}{5}{6}{7}{8}'.format("<peer-address><ip>", peer_address1, "</ip></peer-address><connection-options><incoming-bgp-connection><remote-port>0</remote-port><allow>yes</allow></incoming-bgp-connection><outgoing-bgp-connection><local-port>0</local-port><allow>yes</allow></outgoing-bgp-connection><multihop>0</multihop><keep-alive-interval>10</keep-alive-interval><open-delay-time>0</open-delay-time><hold-time>30</hold-time><idle-hold-time>15</idle-hold-time><min-route-adv-interval>30</min-route-adv-interval></connection-options><local-address><ip>", local_address1, "</ip><interface>", tunnel_int1, "</interface></local-address><peer-as>", vpc_asn, "</peer-as>")
xpath1 = '{0}{1}{2}{3}{4}'.format("/config/devices/entry[@name='localhost.localdomain']/template/entry[@name='T-DEVICE-AWS-TRANSIT-AZ1']/config/devices/entry[@name='localhost.localdomain']/network/virtual-router/entry[@name='vr_master']/protocol/bgp/peer-group/entry[@name='", zone, "']/peer/entry[@name='", peer_address1, "']")


xapi = pan.xapi.PanXapi(api_username = pan_username, \
...
peer2_bgp_xml = '{0}{1}{2}{3}{4}{5}{6}{7}{8}'.format("<peer-address><ip>", peer_address2, "</ip></peer-address><connection-options><incoming-bgp-connection><remote-port>0</remote-port><allow>yes</allow></incoming-bgp-connection><outgoing-bgp-connection><local-port>0</local-port><allow>yes</allow></outgoing-bgp-connection><multihop>0</multihop><keep-alive-interval>10</keep-alive-interval><open-delay-time>0</open-delay-time><hold-time>30</hold-time><idle-hold-time>15</idle-hold-time><min-route-adv-interval>30</min-route-adv-interval></connection-options><local-address><ip>", local_address2, "</ip><interface>", tunnel_int2, "</interface></local-address><peer-as>", vpc_asn, "</peer-as>")
xpath2 = '{0}{1}{2}{3}{4}'.format("/config/devices/entry[@name='localhost.localdomain']/template/entry[@name='T-DEVICE-AWS-TRANSIT-AZ1']/config/devices/entry[@name='localhost.localdomain']/network/virtual-router/entry[@name='vr_master']/protocol/bgp/peer-group/entry[@name='", zone, "']/peer/entry[@name='", peer_address2, "']")
